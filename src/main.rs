...
fn get_smallets_dimensions(dim_1: (u32, u32), dim_2: (u32, u32)) -> (u32, u32) {
...
fn standardize_size(image_1: DynamicImage, image_2: DynamicImage) -> (DynamicImage, DynamicImage) {
    let (width, height) = get_smallets_dimensions(image_1.dimensions(), image_2.dimensions());
